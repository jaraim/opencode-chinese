...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      app_exit: z.string().optional().default("ctrl+c,ctrl+d,<leader>q").describe("退出应用"),
      ...
      session_export: z.string().optional().default("<leader>x").describe("导出会话到编辑器"),
      ...
      session_rename: z.string().optional().default("ctrl+r").describe("重命名会话"),
      session_delete: z.string().optional().default("ctrl+d").describe("删除会话"),
      stash_delete: z.string().optional().default("ctrl+d").describe("删除暂存项"),
      model_provider_list: z.string().optional().default("ctrl+a").describe("从模型对话框打开提供商列表"),
      model_favorite_toggle: z.string().optional().default("ctrl+f").describe("切换模型收藏状态"),
      session_share: z.string().optional().default("none").describe("分享当前会话"),
      session_unshare: z.string().optional().default("none").describe("取消分享当前会话"),
      session_interrupt: z.string().optional().default("escape").describe("中断当前会话"),
      session_compact: z.string().optional().default("<leader>c").describe("精简会话"),
      messages_page_up: z.string().optional().default("pageup,ctrl+alt+b").describe("向上滚动一页消息"),
      messages_page_down: z.string().optional().default("pagedown,ctrl+alt+f").describe("向下滚动一页消息"),
      messages_line_up: z.string().optional().default("ctrl+alt+y").describe("向上滚动一行消息"),
      messages_line_down: z.string().optional().default("ctrl+alt+e").describe("向下滚动一行消息"),
